...
const modules: ModuleData[] = [
    {
        ...
        title: "University & College Management",
    ...
    },
    {
        ...
        description: "End the chaos of lost files and delayed approvals. This module tracks the entire lifecycle of every application and file within the university, providing real-time status visibility to all stakeholders.",
        benefits: [
    ...
    },
    {
        ...
        whyChooseUs: [
            "Professionalize hospitality for university guests.",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        A unified ecosystem of specialized modules designed to streamline every aspect of university operations.
                    </p>
                </div>
