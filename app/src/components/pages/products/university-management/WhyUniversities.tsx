            ...
            <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        ...
                        <div className="hidden lg:flex absolute top-[20%] -left-12 bg-white p-5 rounded-2xl shadow-xl items-start gap-4 animate-float-slow z-10 w-[280px]">
                        ...
                        <div className="hidden lg:flex absolute bottom-[15%] -right-8 bg-white p-5 rounded-2xl shadow-xl items-start gap-4 animate-float-delayed z-10 w-[280px]">
